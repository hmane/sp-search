...
4. **Promote `searchContextId` to property pane page 1 group 1 in all six web parts**
   ...
   - **Effort:** M
   - **Priority:** P0
   - **Depends on:** none (T4 admin experience plan will reference this deliverable for property-pane discoverability — coordinate with T4 plan but ship independently)
